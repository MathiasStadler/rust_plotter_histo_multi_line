...
fn main() {
  let root_area = BitMapBackend::new("images/date_x_axis.png", (600, 400))
    .into_drawing_area();
  root_area.fill(&WHITE).unwrap();

  let start_date = Utc.ymd(2019, 10, 1);
  //let start_date = Utc.with_ymd_and_hms(2019, 10, 1,0,0,0);
  let end_date = Utc.ymd(2019, 10, 18);
  //let end_date = Utc.with_ymd_and_hms(2019, 10, 18,0,0,0);
